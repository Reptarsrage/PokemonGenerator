...
{
    public interface IPokemonTeamProvider
    {
    ...
    /// </summary>
    internal class PokemonTeamProvider : IPokemonTeamProvider
    {
        ...
        public PokemonTeamProvider(IPokemonStatUtility pokemonStatUtility,
            IProbabilityUtility probabilityUtility, IPokemonMoveProvider pokemonMoveProvider,
        ...
        public PokeList GenerateRandomPokemonTeam(int level)
        {
            ...
            // Assign moves
            _pokemonMoveProvider.AssignMovesToTeam(pokeList, level);
